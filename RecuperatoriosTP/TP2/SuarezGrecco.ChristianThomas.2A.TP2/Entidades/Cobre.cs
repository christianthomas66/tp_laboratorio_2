...
namespace Entidades
{
    public class Cobre : Metales
    {
        /// <summary>
        /// Constructor por default de Cobre
        /// </summary>
        public Cobre()
        {
        }
        /// <summary>
        /// Constructor parametrizado de Cobre que instancia los atributos peso, tamanio y TipoMetal
        /// </summary>
        /// <param name="peso"></param>
        /// <param name="tamanio"></param>
        /// <param name="tipoMetal"></param>
        public Cobre(double peso, double tamanio, TipoMetal tipoMetal) : base(peso, tamanio, tipoMetal)
        {
        }
        /// <summary>
